...
class EyeReconstructionDataGenerator(DataGenerator):
    # init
...
class EyeReconstructionModel(Model):
    # init
    def __init__(self, framework):
        super().__init__(framework)
...
if __name__ == '__main__':
    the_framework = TrainingFramework(
        data_generator_cls=EyeReconstructionDataGenerator,
        model_cls=EyeReconstructionModel)
    the_framework.run()